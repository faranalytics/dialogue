...
import { TelnyxController, WorkerPool, log, SyslogLevel } from "@farar/dialogue";
...
new WorkerPool({ controller, workerURL: "file:///home/farar/workspace/repos/phone-thing/dialogue/test/dist/worker.js" });
